...
import googleCalendar from "@/asset/apps/google-calendar.png";
...
export const oauthUrls = {
  GOOGLE_DRIVE: {
    ...
    params: {
      ...
      scope:
        "https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/drive.metadata.readonly https://www.googleapis.com/auth/drive.readonly" // Scope for Google Drive
    }
  },
  ONE_DRIVE: {
    id: 2,
  ...
  DROPBOX: {
    ...
    params: {
      ...
      state: DROPBOX_STR,
      scope:
        "files.metadata.write files.content.read file_requests.write sharing.read contacts.write profile email sharing.write account_info.write"
    }
  },
  GMAIL: {
    id: 4,
  ...
  GOOGLE_CALENDAR: {
    id: 5,
    name: GOOGLE_CALENDAR_STR,
    logo: "google_calendar_logo", // Replace with the path or identifier for your calendar logo
    authUrl: "https://accounts.google.com/o/oauth2/auth",
    params: {
      client_id: process.env.NEXT_PUBLIC_GOOGLE_CLIENT, // Replace with your actual client ID
      redirect_uri: process.env.NEXT_PUBLIC_REDIRECT_URL, // Replace with your actual redirect URI
      ...
      scope: "https://www.googleapis.com/auth/calendar.readonly" // Scope for Google Calendar
    }
  },
  NOTION: {
    id: 6,
